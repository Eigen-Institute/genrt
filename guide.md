...
### 2.1 Dynamics Module: Mamba SSM (NOT Neural ODE)
...
### 2.2 Variable Basis Size: Density-Edge Projection
...
### 2.3 Geometry Conditioning: FiLM (NOT Cross-Attention)
...
### 2.4 Field Encoding: L=1 Spherical Tensor
...
### 2.5 Loss Function: Derivative Loss + Variance Weighting
...
1. **NequIP:** Batzner et al., "E(3)-equivariant graph neural networks for data-efficient and accurate interatomic potentials" (2022)
2. **Mamba:** Gu & Dao, "Mamba: Linear-Time Sequence Modeling with Selective State Spaces" (2023)
3. **RT-TDDFT:** Lopata & Govind, "Modeling Fast Electron Dynamics with Real-Time TDDFT" JCTC (2011)
